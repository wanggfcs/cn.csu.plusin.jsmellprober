...
public class MethodLineCode extends ASTVisitor{
	...
	public boolean visit(MethodDeclaration node) {
		...
		param.setEndLineNum(unit.getLineNumber(node.getStartPosition()+node.getLength()));
		int[] result = sjc.LineOfCode(JdtAstUtil.getFile(unitPath), param.getStartLineNum(), param.getEndLineNum());
...
//			String result = getMethodName()+"\t"+getLineOfCode()+"\t"+getLineOfCodeComment();
//			return result;
//			
//		}
//	}
